...
import edu.depauw.ludo_board_game.ludo.gui.shapes.CircleBoard;
import edu.depauw.ludo_board_game.ludo.gui.shapes.SquareBoard;
import edu.depauw.ludo_board_game.ludo.gui.shapes.TriangleBoard;
...
public class Board 
{
   public static SquareBoard[] MainSquares = new SquareBoard[4];
   public static CircleBoard[] StartingLocations = new CircleBoard[16];
   public static TriangleBoard[] endingLocations = new TriangleBoard[4];
   public static SquareBoard[] MainPath = new SquareBoard[52];
   public static SquareBoard[] finalRed = new SquareBoard[5];
